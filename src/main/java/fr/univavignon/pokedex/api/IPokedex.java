...
public interface IPokedex extends IPokemonMetadataProvider, IPokemonFactory {
	...
	/**
	 * Adds the given <b>pokemon</b> to this pokedex and returns
	 * it unique index.
	 * 
	...
	/**
	 * Locates the pokemon identified by the given <b>id</b>.
	 * 
	...
	/**
	 * Returns an unmodifiable list of all pokemons this pokedex contains.
	 * The list view will be sorted using the given <b>order</b>.
	 * 
